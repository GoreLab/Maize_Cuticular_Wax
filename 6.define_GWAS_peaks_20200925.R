...
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_001")## Up-to-date verstion for 0.05% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_0005")## Up-to-date verstion for 0.05% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_005")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_0001")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_0002")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_FDR10")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_FDR05")## Up-to-date verstion for 0.5% SNP
# 
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_PC_001")## Up-to-date verstion for 0.05% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_PC_0005")## Up-to-date verstion for 0.05% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_PC_0001")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_PC_0002")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_PC_FDR10")## Up-to-date verstion for 0.5% SNP
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_PC_FDR05")## Up-to-date verstion for 0.5% SNP
# 
# setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_FTcov_0002")## Up-to-date verstion for 0.5% SNP
setwd("/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_0002_final")## Up-to-date verstion for 0.5% SNP
...
#import gwas results
## wax
#gwas_res0=fread('/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_0002/wax_GWAS_SD18_both_HapMap3_for_peakSNPs.txt',data.table = F)
#gwas_res0=fread('/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP/wax_GWAS_SD18_both_HapMap3_for_peakSNPs_05perc.txt',data.table = F, stringsAsFactors = F)
...
# FFA_C20 and FFA_C22 with FT as covariate
gwas_res0=fread('/workdir/ml2498/MaizeLeafCuticle/Wax_TWAS/GAPIT/HMP3_NOPR_450to310_LD02/peak_SNP_FTcov_0002/wax_GWAS_SD18_HapMap3_for_peakSNPs_FTcov.txt',data.table = F)
...
for(t in traits){
  ...
  all_chr=all_chr[grep(paste("^",t,'_',sep=''),all_chr)] # Meng's edit: add "^"
...
for(t in traits){
  ...
  if(nrow(curr_gwas_peak3_no_na)>=2){ ## Meng added this line
